...
## (1) Obtain Access to IEA WEEB Data

The PFU database contains [World Extended Energy Balance](https://www.iea.org/data-and-statistics/data-product/world-energy-balances#energy-balances) (WEEB) data. To use the PFU Database, you or your institution must already have purchased the WEEB data, obtained a license to use the WEEB data, or subscribed to a data service with access to the WEEB data. At present, you must have access to all countries and all years of WEEB data to access the PFU Database.
