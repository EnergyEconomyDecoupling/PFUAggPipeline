...
The PFU Database contains primary, final, and useful 
energy and exergy data for all countries covered 
by the International Energy Agency (IEA).
Aggregations are also available. 

But it can be a challenge to get started with the PFU Database
...
The graph above is aesthetically pleasing and conveys more information
that the initial attempt.
