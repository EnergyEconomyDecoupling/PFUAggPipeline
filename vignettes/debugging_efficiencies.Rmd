...
So we see that $\eta_{i, Charcoal production plants}$ values are $\infty$ 
for 1971--2010, far more years than OAMR has overall $\eta_{pf} > 1$.

To investigate further, let's look at the ECC for 2011, 
